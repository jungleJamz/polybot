import type { PolymarketMarket, OddsAPIEvent, OddsAPIMarket, MatchedMarket, MarketType } from "../types.js";
...
if (
    (market.marketType === "spreads" || market.marketType === "spreads_h1" ||
    market.marketType === "totals"  || market.marketType === "totals_h1") &&
    requiredLine === null
) {
...
if (Object.keys(result.sportsbooks).length === 0) {
    ...
    const lines = Array.from(available).sort((a, b) => a - b).join(", ");
